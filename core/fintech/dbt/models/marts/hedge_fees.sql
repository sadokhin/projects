...
main as (
    select
        ...
        hedge.start as fees_processed_at,
        hedge.finish as answer_received_at,
        (toUnixTimestamp64Micro(hedge.start) - toUnixTimestamp64Micro(events.time_app)) / 1000 as fees_processed,
