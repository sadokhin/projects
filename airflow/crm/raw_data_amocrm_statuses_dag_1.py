"""
load data about lead's stages and pipelines from pipelines in amocrm and push this data into google bigquery
"""
...
TABLE_PIPELINE = 'amocrm_pipelines'
TABLE_STAGES = 'amocrm_stages'
...
with models.DAG(
    ...
    async def pipeline_list():
        ...
        #save value of new refresh token to airflow variable
        response = _call_amo_method('leads/pipelines', '')
    ...
    def load_statuses():
        ...
        load_data_to_bq(TABLE_NAME_PIPELINE,df_pipelines, mode = 'WRITE_TRUNCATE')
        load_data_to_bq(TABLE_NAME_STAGES,df_stages, mode = 'WRITE_TRUNCATE')
